...
const none0 = [
  ...
  "While meditating, Let your thoughts pass; if you think of something important, quickly write it down using the note tool, then let the thought go",
  "Find a comfortable sitting position.",
  "Be alert in your posture, not rigid, and not slouching, shoulders upright.",
  ...
  const fear0 = [
   ...
   "embrace uncertainty, cast off fear",
    ...
    "Listen to the prompts that align with your values, ignore the ones that don't", 
    "While meditating, Let all thoughts pass, if you think of something important, write it down using the note tool, then let it go",

    "Find a comfortable sitting position.",
    "Be alert in your posture, not rigid or slouching, body upright.",
    "now close your eyes or pick a focal point.",
  ...
  const fear2 = [
    ...
    "accept chaos,Do not fear chaos",
    "Embrace uncertainty",
...
"The fear of judgment has no power over my self-esteem; I am unshakable in my worth."
  ...
  //done
  const people0 = [
    "This tool helps us to become better at social situations, and being with other people without being overly anxious",
   "learn to enhance your people skills and want for human interaction",
   
    "this process incorporates aspects of mindfulness meditation",
    "trust the process, trust yourself, trust those worthy",
    "Listen to the prompts that align with your values, ignore the ones that don't", 
    "While meditating, Let your thoughts pass; if you think of something important, write it down using the note tool, then let the thought go",
    "Find a comfortable sitting position.",
    "Be alert in your posture, not rigid, not slouching, head and body upright.",
    "now close your eyes or pick a focal point.",
  ...
  const people1 = [
    ...
    "The mind is constantly chattering; accept and let go and come back to the breath.",
    "If you don't want to think about something, you will think about it; instead of pushing it away, just accept and let go, don't give it a value, don't label it, just accept it, and let it pass.",
    "Let your thoughts pass; if you think of something you need to remember, quickly write it down, then come back to the breath.",
    "Your thoughts are not you.",
    "You'll notice the mind's constant chatter; you cannot stop your thoughts, but you can stop being controlled by them.",
    "Allow your mind to rest and relax in this moment.",
    "Gently return your attention to the breath whenever you get distracted.",
 ...
 //done 
  const love0 = [
   ...
   "this process incorporates aspects of mindfulness meditation and loving kindness meditation",
    ...
    "Find a comfortable sitting position.",
    "Be alert in your posture, not rigid, not slouching, body upright.",
    "now close your eyes or pick a focal point.",
...
const mindfulness0 = [
  ...
  "While meditating, focus on your breath as the air passess in and out of your lungs", 
  "as thoughts arise, Let them pass without placing a value on them", 
  "if you have a difficult thought, accept it and let it go while bringing your focus back to the breath",
  "if you think of something important, write it down using the note tool then let the thought go",
  "trust the process",
  "Even small amounts of regular meditation are beneficial.",
  "listen to the prompts that you align with and ignore the rest", 
  "Find a comfortable sitting position.",
  "Be alert in your posture, not slouching, head and body upright.",
  "now close your eyes or pick a focal point.",
  "Let's begin by bringing our full attention to our breath.",
